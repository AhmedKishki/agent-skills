...
| Design the argument | Approved direction | [Article arc](references/article-arc.md) | Approved sections, passages and arguments |
| Construct one candidate | Approved passage plan and input set | [White-box synthesis](references/white-box-synthesis.md) | Candidate with record, or typed gap |
