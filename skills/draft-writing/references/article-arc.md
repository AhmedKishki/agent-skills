...
## File shape — `{project}-article-arc.md`
    ...
    **Thesis:** the exact thesis sentence
    ...
    Paragraph 1 claim → paragraph 2 claim → …
...
A paragraph line states its claim; a sentence line states its proposition. Add a short em-dash note — a point of emphasis or an include/exclude boundary — only where synthesis genuinely needs it. List only the sources that inform the sketch. The section names above are illustrative.
