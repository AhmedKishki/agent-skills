...
After a change, retain only work that passes the [unaffected-work test](file-output-standard.md), use source paths to rescan plausibly affected sources, and revalidate dependents. Ask on uncertain relevance or fit; omit invalid dependents and create no impact file.
