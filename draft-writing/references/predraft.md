...
Any added, replaced, withdrawn, or corrected passage returns the predraft to **Working**, marks affected arc dispositions unresolved, and invalidates the current predraft report/draft after the required removal-impact notice. Reapprove the complete predraft before a new [predraft report](predraft-report.md) may be requested.
