...
1. Before draft assembly, attempt eligible Human wording and relations with [white box synthesis](white-box-synthesis.md). If assembly exposed the gap, first return to the affected arc or predraft work.
