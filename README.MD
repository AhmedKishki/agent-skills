...
| Skill | Purpose |
|---|---|
| [`draft-writing`](draft-writing/) | Collaboratively assemble a user-controlled, source-grounded article through local predrafting, whole-predraft diagnosis, and report-gated global refinement. |
